...
type RemoveSavedSupplierModalProps = {
  open: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
export function RemoveSavedSupplierModal({
  open,
  onClose,
  onConfirm,
  supplierName,
  isSubmitting = false,
}: RemoveSavedSupplierModalProps) {
  ...
  return createPortal(
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="remove-saved-supplier-modal-title"
        aria-describedby="remove-saved-supplier-modal-description"
        aria-label={
          supplierName
            ? `Remove saved supplier ${supplierName}`
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <h2
            id="remove-saved-supplier-modal-title"
          ...
          <div
            id="remove-saved-supplier-modal-description"
